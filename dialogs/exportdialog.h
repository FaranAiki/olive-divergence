...
private:
  ...
  /**
   * @brief GroupBox containing all preferences (before-after) exports UI objects
   */
  QGroupBox* preferenceGroupbox;
  
  /**
   * @brief CheckBox to enable shutdown after exporting
   */
  QCheckBox* shutdown_after_checkbox;
